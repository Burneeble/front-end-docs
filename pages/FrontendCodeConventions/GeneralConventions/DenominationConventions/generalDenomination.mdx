## Every denomination must be general and not specific

Regarding file names, variables, and other elements, one should always be careful with the names chosen. In fact, giving a specific name like "X" may become inconvenient in the future if it needs to be changed to "Y." Let's illustrate with an example:
...
![general-denomination](../../../images/code-conventions/general-conventions/general-denomination.png)
